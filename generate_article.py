...
REPO_URL = "https://github.com/aniket-work/BridgeGuard-AI" 
RAW_GIT_BASE = "https://raw.githubusercontent.com/aniket-work/BridgeGuard-AI/main"

def generate_article():
    sections = []
    
    # 5000 word target means ~35000 characters. I'll be very detailed.
    sections.append(f"""---
title: "{TITLE}"
subtitle: "{SUBTITLE}"
published: true
...
![Title]({RAW_GIT_BASE}/images/title_diagram.png)
...
![Architecture]({RAW_GIT_BASE}/images/architecture_diagram.png)
...
![Sequence]({RAW_GIT_BASE}/images/sequence_diagram.png)
...
![Simulation Output]({RAW_GIT_BASE}/images/title-animation.gif)
...
""")
    ...
    if os.path.exists("generated_article.md"):
        os.remove("generated_article.md")
        
    with open("generated_article.md", 'w', encoding='utf-8') as f:
        f.write(content)
        
    print(f"Article expanded: generated_article.md (Word count: {{len(content.split())}})")
